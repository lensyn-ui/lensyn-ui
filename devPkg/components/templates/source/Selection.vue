    ...
    export default{
        ...
        watch: {
            "objProps.list": function (datas) {
                if (datas && datas[0] && typeof datas[0]._select_show === "undefined") {
        ...
        methods: {
             ...
             */
            showBoxFunc() {
                let height = this.$refs.selectIpt.offsetHeight;
        ...
        created() {
            ...
            this.objProps.placeholder = this.objProps.placeholder ? this.objProps.placeholder : "请输入关键字";
